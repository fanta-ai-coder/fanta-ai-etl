...
with col_roster:
    ...
    if quot_view.empty:
        ...
        # Anchor mantenuto perché il CSS esistente può continuare
        # a personalizzare l'aspetto delle singole righe.
        st.markdown('<div id="roster-anchor"></div>', unsafe_allow_html=True)

        # Container con altezza fissa:
        # circa 18-20 giocatori visibili contemporaneamente.
        with st.radio(options=labels):
